...
export default function UploadPage() {
  ...
  async function submitUpload(e) { e.preventDefault(); if(!upload.file) return alert('Select a file'); const d = await NotesAPI.upload(upload); setNotes(n=>[d.note,...n]); setUpload({ title:'', description:'', subject: 'General', file:null }); alert('Uploaded!') }
